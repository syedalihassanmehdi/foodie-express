...
export function Sidebar() {
  ...
  return (
    <aside style={{
      width: "220px", minHeight: "100vh", backgroundColor: "#fff",
      borderRight: "1px solid #f0f0f0", display: "flex", flexDirection: "column",
      fontFamily: "'DM Sans', sans-serif", position: "fixed", top: 0, left: 0, zIndex: 50,
    }}>
      <div style={{ padding: "24px 20px", borderBottom: "1px solid #f0f0f0", display: "flex", alignItems: "center", gap: "10px" }}>
        <div style={{ width: "36px", height: "36px", borderRadius: "10px", backgroundColor: "#f97316", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "18px" }}>🍕</div>
        <div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href} style={{
              ...
              fontWeight: active ? 700 : 500, color: active ? "#f97316" : "#555",
